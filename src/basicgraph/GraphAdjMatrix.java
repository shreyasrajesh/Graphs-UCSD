...
public class GraphAdjMatrix extends Graph {
	...
	public List<Integer> getDistance2(int v) {
		...
		for (int i=0;i<getNumVertices(); i++)
		{
			...
			{
				if(adjMatrix2[v][j] > 0){
					for(int k=0;k<adjMatrix2[v][j];k++)
						{
						secondneighbors.add(j);
						}
				}
			}
...
//		List<Integer> secondNeighbors = new ArrayList<Integer>();
//		int[][] adjMatrix = new int[getNumVertices()][getNumVertices()];
//		int[][] secondAdjMatrix = new int[getNumVertices()][getNumVertices()];
//		
//		for(int i=0;i<getNumVertices();i++)
//		{
//			for(int k=0;k<getNeighbors(i).size();k++)
//			{
//				for(int j=0;j<getNumVertices();j++)
//				{
//					if((getNeighbors(i)).get(k) == j)
//					{
//						adjMatrix[i][j] = 1;
//					}
//					else
...
//				for(int k=0;k<getNumVertices();k++)
//				{
//					secondAdjMatrix[i][j] = secondAdjMatrix[i][j] + adjMatrix[i][k]*adjMatrix[k][j];
//				}
//			}
//		}
//		for(int i=0;i<getNumVertices();i++)
...
//			for(int j=0;j<getNumVertices();j++)
//			{
//				System.out.print(secondAdjMatrix[i][j] + " ");
//			}
//			System.out.println();
//		}
//		System.out.println();
//		// Making a list of the second neighbors
//		for(int j=0;j<getNumVertices();j++)
//		{
//			if(secondAdjMatrix[v][j] > 0)
//			{
//				for(int a=0;a<secondAdjMatrix[v][j];a++)
//				{
//					secondNeighbors.add(j);
//				}
//			}
